...
export const createInformationValidationRules = [
	...
	...INFORMATION_VALIDATOR.REQUIRED.CONTENT(), // Will be conditionally validated only for type TEXT
	...INFORMATION_VALIDATOR.TYPE_SPECIFIC.FILE_REQUIRED(), // Ensures a file is present for IMAGE and VIDEO types
	...INFORMATION_VALIDATOR.OPTIONAL.STATUS(STATUS), // Status is optional, uses default value if not provided
]
