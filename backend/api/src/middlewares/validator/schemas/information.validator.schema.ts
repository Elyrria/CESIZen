  ...
  REQUIRED: {
    ...
    NAME: () => [
      body(FIELD.NAME)
        ...
        .withMessage("The name should only contain alphanumeric characters, dashes, or underscores")
        .escape()
        .trim()
    ],
      ...
      body(FIELD.CATEGORY_ID)
        ...
        .custom((value) => {
          ...
          if (!mongoose.Types.ObjectId.isValid(value)) {
            throw new Error(`The ${FIELD.CATEGORY_ID} must be a valid MongoDB ObjectID`)
          }
          return true
        })
    ]
      ...
      body(FIELD.CATEGORY_ID)
        ...
        .custom(async (value, { req }) => {
          ...
          try {
            ...
            throw error instanceof Error ? error : new Error("Error validating category")
          }
        })
    ]
  }
