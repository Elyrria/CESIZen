# Documentation des Tests d'Intégration du Controller User
...
- **Sortie Attendue** :
  ...
  - Objet utilisateur complet avec tous les champs (email, name, firstName, birthDate, role, active, createdAt, updatedAt, \_\_v, id)
...
### TC-003 : Rejet d'une requête avec champs manquants
