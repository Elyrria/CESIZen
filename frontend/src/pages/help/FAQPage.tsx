        ...
        <div className="bg-white rounded-lg shadow-fr-md p-8">
          ...
          <div className="space-y-4">
            {faqData.map((item, index) => (
              <div key={index} className="border border-fr-grey-light rounded-lg overflow-hidden">
                <button
                ...
                >
                  <div className="flex justify-between items-center">
                    <h3 className="text-lg font-semibold text-fr-blue">{item.question}</h3>
                    <svg
                ...
                {openItems.has(index) && (
                  ...
                  >
                    <p className="text-fr-grey-dark leading-relaxed">{item.answer}</p>
                  </div>
                )}
              </div>
            ))}
