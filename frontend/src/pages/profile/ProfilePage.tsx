            ...
            content: editField ? (
              <div className="max-w-lg mx-auto bg-white rounded-xl shadow-lg p-8 border border-fr-grey-light">
                ...
                <div className="mb-4">
                  {editField === "password" ? (
                    <div>
                      <label className="block font-medium mb-1">Ancien mot de passe</label>
                      <input
                        type="password"
                      ...
                      />
                      <label className="block font-medium mb-1 mt-2">Nouveau mot de passe</label>
                      <input
                        type="password"
                        value={newPassword}
                    ...
                    <div>
                      <label className="block font-medium mb-1">{fieldLabels[editField]}</label>
                      <input
                        type={editField === "birthDate" ? "date" : "text"}
                        value={value}
