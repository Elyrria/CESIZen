    ...
    <div className="space-y-6">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-medium text-yellow-800 mb-1">Processus de validation</h4>
            <p className="text-sm text-yellow-700">
              Vos informations sont actuellement en cours de validation par notre équipe. Vous
              recevrez une notification une fois le processus terminé. Le délai moyen est de 1-2
              jours ouvrés.
            </p>
          </div>
        </div>
        ...
        <div className="bg-fr-grey-light p-4 rounded-lg">
          ...
          <ul className="space-y-2 text-sm text-fr-grey-dark">
            <li className="flex items-start gap-2">
              ...
              <span>
                Vos informations sont en cours de validation par notre équipe de modération.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-fr-blue">•</span>
              <span>Vous ne pouvez plus modifier le contenu une fois soumis.</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-fr-blue">•</span>
              <span>
                Si des modifications sont nécessaires, l'information sera renvoyée en brouillon.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-fr-blue">•</span>
              <span>Une fois validées, vos informations seront automatiquement publiées.</span>
            </li>
          </ul>
        </div>
      )}
