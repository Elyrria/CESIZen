  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-semibold text-fr-blue">Créer une Nouvelle Information</h3>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-medium text-blue-800 mb-1">Processus de publication</h4>
            <div className="text-sm text-blue-700 space-y-1">
              <p>
                1. <strong>Création :</strong> Votre information sera sauvegardée en brouillon
              </p>
              <p>
                2. <strong>Révision :</strong> Vous pouvez la modifier autant que nécessaire
              </p>
              <p>
                3. <strong>Soumission :</strong> Envoyez-la pour validation quand elle est prête
              </p>
              <p>
                4. <strong>Publication :</strong> Elle sera publiée après validation par notre
                équipe
              </p>
            </div>
          </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-yellow-700">
              Assurez-vous que votre contenu respecte nos conditions d'utilisation. Les informations
              inappropriées ou contraires à nos règles seront refusées lors de la validation.
            </p>
          </div>
        </div>
      </div>
