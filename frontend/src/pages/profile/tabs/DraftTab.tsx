    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-fr-grey-dark">Gérez vos informations en cours de rédaction</p>
        </div>
      ...
      {!information.isLoading && draftInformations.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-fr-grey-dark mb-4">Créez votre première information pour commencer.</p>
          <button onClick={handleCreateNew} className="fr-btn fr-btn--primary">
            Créer une information
          </button>
        </div>
