        ...
        <div className="text-center max-w-md">
          ...
          <div className="mt-8 pt-8 border-t border-fr-grey-light">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link to="/informations" className="text-fr-blue hover:underline text-sm">
                Informations
              </Link>
              <Link to="/profile" className="text-fr-blue hover:underline text-sm">
                Profil
              </Link>
              <Link to="/faq" className="text-fr-blue hover:underline text-sm">
                FAQ
              </Link>
            </div>
          </div>
