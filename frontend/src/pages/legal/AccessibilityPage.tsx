      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-fr-md p-8">
          ...
          <div className="prose prose-blue max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Technologies utilisées</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
                L'accessibilité de ce site s'appuie sur les technologies suivantes :
              </p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">État de conformité</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Contenus non accessibles</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
                Les contenus listés ci-dessous ne sont pas accessibles pour les raisons suivantes :
              </p>
              <ul className="list-disc list-inside text-fr-grey-dark space-y-2 mb-4">
                <li>Non-conformité avec le RGAA : Lorem ipsum dolor sit amet</li>
                <li>Charge disproportionnée : Consectetur adipiscing elit</li>
                <li>Contenu tiers : Sed do eiusmod tempor incididunt</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Amélioration et contact</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
                Si vous n'arrivez pas à accéder à un contenu ou à un service, vous pouvez nous
                contacter pour être orienté vers une alternative accessible ou obtenir le contenu
            ...
            <section>
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Voie de recours</h2>
              <p className="text-fr-grey-dark leading-relaxed">
                Cette procédure est à utiliser dans le cas suivant : vous avez signalé au
                responsable du site internet un défaut d'accessibilité qui vous empêche d'accéder à
                un contenu ou à l'un des services du portail et vous n'avez pas obtenu de réponse
                satisfaisante.
              </p>
            </section>
          </div>
