    ...
    <div className="min-h-screen bg-fr-grey-light/20 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-lg shadow-fr-md p-8">
          <h1 className="text-3xl font-bold text-fr-blue mb-8">Privacy Policy</h1>

          <div className="prose prose-blue max-w-none">
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Personal Data Collection</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
                ...
                risus varius blandit sit amet non magna. Cras mattis consectetur purus sit amet
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Data Usage</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
                Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel
                scelerisque nisl consectetur et. Morbi leo risus, porta ac consectetur ac,
                vestibulum at eros.
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-fr-grey-dark leading-relaxed mb-4">
                Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. Integer posuere
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">GDPR Rights</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Contact</h2>
              <p className="text-fr-grey-dark leading-relaxed">
                Pour exercer vos droits ou pour toute question relative à cette politique de
                confidentialité, vous pouvez nous contacter à l'adresse suivante :
                <a href="mailto:contact@cesizen.fr" className="text-fr-blue hover:underline ml-1">
                  contact@cesizen.fr
                </a>
              </p>
            </section>
