        ...
        <div className="bg-white rounded-lg shadow-fr-md p-8">
          ...
          <div className="prose prose-blue max-w-none">
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Éditeur du site</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Hébergement</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-fr-blue mb-4">Propriété intellectuelle</h2>
              <p className="text-fr-grey-dark leading-relaxed mb-4">
