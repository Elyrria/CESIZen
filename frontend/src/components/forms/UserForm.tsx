    ...
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            {...register("email")}
          />
          {errors.email && <p className="text-fr-red text-sm mt-1">{errors.email.message}</p>}
        </div>
        ...
        <div>
          ...
          {errors.role && <p className="text-fr-red text-sm mt-1">{errors.role.message}</p>}
        </div>
      </div>
      ...
      <div>
        ...
        <input
          ...
          {...register("birthDate")}
        />
        {errors.birthDate && <p className="text-fr-red text-sm mt-1">{errors.birthDate.message}</p>}
      </div>
      ...
      <div>
        ...
        <input
          ...
          type="password"
          placeholder={
            mode === "create" ? "Minimum 8 caractères" : "Laisser vide pour ne pas changer"
          }
          className={`w-full px-4 py-3 rounded-md bg-white text-fr-blue border border-gray-300 focus:outline-none focus:ring-2 focus:ring-fr-blue focus:border-fr-blue ${
          ...
          {...register("password")}
        />
        {errors.password && <p className="text-fr-red text-sm mt-1">{errors.password.message}</p>}
      </div>
