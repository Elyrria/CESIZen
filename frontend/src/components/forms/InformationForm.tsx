    ...
    <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-6">
      ...
      <div>
        ...
        {errors.descriptionInformation && (
          <p className="text-fr-red text-sm mt-1">{errors.descriptionInformation.message}</p>
        )}
      </div>
      ...
      {watchedType === "TEXT" && (
        <div>
          ...
          />
          {errors.content && <p className="text-fr-red text-sm mt-1">{errors.content.message}</p>}
        </div>
      )}
        ...
        <div className="space-y-2 max-h-40 overflow-y-auto bg-gray-50 border border-gray-300 rounded-md p-4">
          {categories.map((category) => (
            ...
            >
              ...
              <span className="text-gray-700 select-none">{category.name}</span>
            </label>
          ))}
        </div>
        {errors.categoryId && (
