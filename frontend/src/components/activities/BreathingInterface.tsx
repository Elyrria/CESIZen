    ...
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <div className="text-4xl font-bold text-green-600 mb-2">{formatTime(elapsedTime)}</div>
            <div className="text-sm text-fr-grey font-medium">Temps écoulé</div>
          </div>
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <div className="text-4xl font-bold text-purple-600 mb-2">{totalDuration}min</div>
            <div className="text-sm text-fr-grey font-medium">Durée totale</div>
          </div>
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <div className="text-4xl font-bold text-yellow-600 mb-2">{Math.round(progress)}%</div>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/20">
          <div className="flex justify-between items-center mb-3">
            <span className="text-sm font-medium text-fr-grey-dark">Progression de la séance</span>
            <span className="text-sm font-bold text-fr-blue">{Math.round(progress)}%</span>
          </div>
