      ...
      <div className="container mx-auto px-fr-4v">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-fr-4v">
            ...
            <Link to="/informations" className="fr-text hover:text-fr-blue transition-colors">
              Informations
            </Link>
            ...
            {isAuthenticated ? (
              <>
                <Link to="/profile" className="fr-text hover:text-fr-blue transition-colors">
                  Mon profil
                </Link>
          ...
          <div className="container mx-auto px-fr-4v py-fr-4v space-y-fr-4v">
            ...
            {isAuthenticated && (
              <div className="py-3 border-b border-gray-100 mb-4">
                <p className="text-fr-blue font-medium">Hello, {firstName}</p>
            ...
            <Link to="/" className="block py-fr-2v" onClick={() => setMobileMenuOpen(false)}>
              Accueil
            </Link>
            <Link
              to="/informations"
