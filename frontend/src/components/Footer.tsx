        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-fr-4v">
            ...
            <p className="text-sm text-fr-grey-dark">
              L'application de votre santé mentale, proposée par le Ministère de la Santé et de la
              Prévention.
            </p>
          </div>
          ...
          <div>
            <h5 className="font-bold mb-fr-4v text-fr-blue">Informations légales</h5>
            <ul className="space-y-fr-3v">
              <li>
                <Link
                  to="/mentions-legales"
