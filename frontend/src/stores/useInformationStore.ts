    ...
    (set) => ({
      ...
      createInformation: async (formData) => {
        ...
        try {
          ...
          if (response.success && response.data && response.data.information) {
            const newInformation = entityFactory.createInformation(response.data.information)
      ...
      updateInformation: async (id, formData) => {
        ...
        try {
          ...
          if (response.success && response.data) {
            // @ts-ignore
            const updatedInformation = entityFactory.createInformation(response.data)
        ...
        try {
          ...
          if (response.success) {
            ...
            set((state) => ({
              ...
              selectedInformation:
                state.selectedInformation?.id === id ? null : state.selectedInformation
            }))
