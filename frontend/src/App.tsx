...
const App: React.FC = () => {
  ...
  return (
    <Router>
      <AuthInitializer>
        {/* Integrate IdleWrapper only for logged-in users */}
        {auth.user ? (
          <IdleWrapper idleTime={15 * 60 * 1000} warningTime={2 * 60 * 1000}>
            <Layout>
              <AppRoutes />
            </Layout>
          </IdleWrapper>
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/informations/:id" element={<InformationDetailPage />} />
